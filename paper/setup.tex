...
\lstset{
	...
	% Style for comments
	commentstyle={\smaller\itshape\textcolor{commentcolor}},
...
\lstdefinelanguage{b} {
  morekeywords=[1]{MACHINE, SETS, CONSTANTS, VARIABLES, PROPERTIES, INVARIANT, OPERATIONS, PRE, THEN, END, INITIALISATION, ANY, WHERE},
