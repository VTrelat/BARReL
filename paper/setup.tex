...
\newcommand\bmin[1]{\ensuremath{\operatorname{min}(#1)}}
...
\lstdefinelanguage{b} {
morekeywords=[1]{MACHINE, REFINEMENT, IMPLEMENTATION, REFINES, SEES, INCLUDES, IMPORTS, EXTENDS, SETS, CONSTANTS, VARIABLES, PROPERTIES, INVARIANT, OPERATIONS, PRE, IF, THEN, END, INITIALISATION, ANY, WHERE},
