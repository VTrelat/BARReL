...
\paragraph*{\rw{But how does it work?}{Handling well-definedness and user-level workflow}}
...
Instead of handling the bookkeeping ourselves, we generate meta-variables (containing their local contexts) in place of the WD conditions.
...
Accordingly, \barrel reduces the trusted computing base for the \emph{translation} step.
