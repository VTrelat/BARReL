...
\barrel makes use of the same WD conditions for both integers, reals, and actually any type implementing a \emph{partial order}, requiring non-emptiness and boundedness below (resp.\@ above) for minimum (resp.\@ maximum).
\end{remark}
