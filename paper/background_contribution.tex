...
The only difference is that Atelier~B already performs some simplification steps---like removing unnecessary hypotheses and basic simplification---on the WD goals at generation time, which may alter the PO, whereas our WD conditions are generated from the exact Lean context.
