...
Furthermore, these WD conditions are only generated for the goal itself but not during proof steps. This may lead to inconsistencies if the user is not careful enough for instance when instantiating quantified variables in the interactive prover.
