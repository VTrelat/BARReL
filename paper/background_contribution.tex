...
We later assign the generated meta-variables with fresh theorem names whose propositions are extracted from the context of the meta-variable. \todo[needs further explaining or an example?]\warn[Hard to give such an example in my opinion...]
All the previous steps are performed by the command \texttt{import machine <name> from <folder>}\todo[expand on \texttt{machine} yet?].
