...
\begin{example}
	...
	\[
		\begin{split}
			P := \forall\, & (S : \mathtt{Set}\, \mathbb{Z})\, (h_1 : S \in \mathtt{B.Builtins.FIN_1}\ \mathbb{Z}) (h_2 : \forall\, (x : \mathbb{Z})\, (h_3 : x \in S),\ x \le 0), \\
			               & \quad \mathtt{B.Builtins.min}\ S\ (\metavar{m_1}\ S\ h_1\ h_2) \le 0
		\end{split}
	\]
	...
	A fresh theorem statement $min\_wd_1$ is then generated---and remains to be proved---from the type of $\metavar{m_1}$ universally quantified by its local context: \[
		\begin{split}
			...
			& \qquad \forall\, (S : \mathtt{Set}\ \mathbb{Z})\, (h_1 : S \in \mathtt{B.Builtins.FIN_1}\ \mathbb{Z})  (h_2 : \forall\, (x : \mathbb{Z})\, (h_3 : x \in S),\ x \le 0), \\
			& \qquad\qquad \mathtt{B.Builtins.min.WD}\ S
		\end{split}
	\]
