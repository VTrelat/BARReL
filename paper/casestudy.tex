...
Fortunately, \barrel's automation is able to discharge most of the resulting WD conditions automatically, as showcased in this case study.
...
\begin{example}
	Consider this very simple B machine\footnote{This example is available as ``\texttt{DerivFalse.lean}'' in the artifacts.}, containing only one, clearly unprovable assertion:
