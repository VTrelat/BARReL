...
\begin{example}
Consider the very simple B machine\footnote{This example is available as ``\texttt{DerivFalse.mch}'' in the artifacts.}, shown in Listing~\ref{lst:deriv-false}, containing only one, clearly unprovable assertion.
...
END
\end{lstlisting}
Atelier~B's interactive prover allows discharging this assertion by executing the following commands in sequence:
\begin{itemize}
