...
\footnote{
The following assertion: $\exists x, x \in \mathbb{N} \land x \notin \mathbb{Z}$ can be discharged in the interactive prover with the instantiation $x := \min(\varnothing)$ via the tactic \texttt{se} and a call to the automatic internal prover \texttt{pp}.}.
