...
\begin{example}
Consider the very simple B machine\footnote{This example is available as ``\texttt{DerivFalse.lean}'' in the artifact.}, shown in Listing~\ref{lst:deriv-false}, containing only one, clearly unprovable assertion.
...
END
\end{lstlisting}
Atelier~B's interactive prover allows discharging this assertion by executing the following commands in sequence in the interactive proof editor:
\begin{itemize}
