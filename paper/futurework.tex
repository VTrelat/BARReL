...
Finally, the artifact also contains examples from the paper and more that exercise the end-to-end workflow.
...
Since \barrel operates entirely inside Lean, such automation can remain \emph{proof-producing}, meaning that such tactics can synthesize proof terms which are still available for user inspection.
