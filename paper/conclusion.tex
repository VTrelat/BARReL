...
The artifact is a standard Lean~4 project and pins its dependencies via \texttt{lean-toolchain} and \texttt{lake-manifest.json}; a typical build is \texttt{lake update} followed by \texttt{lake build}.
