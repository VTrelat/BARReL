...
The B method is deeply rooted in classical set theory.
...
This is a convenient representation since Mathlib comes batteries included\fixme[remove?] with many definitions and theorems related to \texttt{Set} for us to use when proving the translated obligations in Lean.
