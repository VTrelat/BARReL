...
This is a convenient representation since Mathlib comes batteries included with many definitions and theorems related to \texttt{Set} for us to use when proving the translated obligations in Lean.
