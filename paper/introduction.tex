...
There were also developments in Rocq~\cite{Coq12} targeting PVS~\cite{Bodeveix2002BtoPVS}, focusing primarily on formalizing the semantics of B rather than providing an integrated backend, and Atelier~B’s own interactive prover is comparatively dated and lacks many modern features.
