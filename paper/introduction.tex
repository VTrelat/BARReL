...
The library provides commands \fixme[detail?] allowing a user to turn B developments into a sequence of Lean goals corresponding to the POs of the developments;\@ users then discharge these goals interactively with standard tactic scripts, and the resulting theorems are added to the environment under names derived from the original POG tags.
