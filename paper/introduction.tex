...
\begin{itemize}
  ...
  \item an evaluation on a small refinement chain that demonstrates that an Atelier~B-style refinement workflow can be carried out end-to-end inside Lean, with most WD side-conditions discharged automatically.
\end{itemize}
