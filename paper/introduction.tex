...
\begin{itemize}
	...
	\item an evaluation on a small refinement chain that demonstrates that an Atelier~B-style refinement workflow can be carried out end-to-end \fixme[?] inside Lean, with most well-definedness side-conditions discharged automatically.
\end{itemize}
