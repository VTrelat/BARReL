...
Vendored from Lean core `Lean.Data.Xml.Parser` (leanprover/lean4 @ v4.28.0), which was
removed from core in v4.29.0 (PR #12302: "chore: remove unused `Lean.Data.Xml`"). Kept
here so BARReL can build on Lean ≥ v4.29.0. The XML grammar below is verbatim upstream;
only the module-system boilerplate was dropped and `Lean.Xml` re-namespaced to `B.Xml`.
-/
import Std.Internal.Parsec
import Init.Data.String.Search
import POGReader.Xml.Basic
